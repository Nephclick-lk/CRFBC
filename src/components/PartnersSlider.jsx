...
export default function PartnersSlider() {
  ...
  const logos = [dgiLogo, kraLogo, traLogo, uraLogo, zraLogo];
  
  return (
    <section style={{ padding: '60px 0', backgroundColor: '#ffffff', overflow: 'hidden', borderTop: '1px solid var(--color-border)' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: '700', color: 'var(--color-text-dark)' }}>Our Trusted Partners</h2>
          <p style={{ color: 'var(--color-text-muted)' }}>Working together with leading authorities across the region.</p>
        </div>
      </div>
